...
run pip-compile --strip-extras --allow-unsafe --generate-hashes --quiet --upgrade --output-file requirements/requirements.txt pyproject.toml
run pip-compile --strip-extras --allow-unsafe --generate-hashes --quiet --upgrade --extra dev --output-file requirements/requirements-dev.txt pyproject.toml
