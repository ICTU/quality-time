...
class GetLatestTagTest(unittest.TestCase):
    ...
    def test_up_to_date(self, mock_get: Mock):
        ...
        self.create_mock_response(mock_get, {"results": [{"name": "1.0", "digest": DIGEST}]})
    ...
    def test_new_version_available(self, mock_get: Mock):
        ...
        self.create_mock_response(mock_get, {"results": [{"name": "2.1", "digest": DIGEST}]})
    ...
    def test_ignore_tags_without_digest(self, mock_get: Mock):
        ...
        self.create_mock_response(mock_get, {"results": [{"name": "2.2", "digest": DIGEST}, {"name": "2.3"}]})
    ...
    def test_multiple_new_versions_available_across_pages(self, mock_get: Mock):
        ...
        response1.json.return_value = {
            "results": [{"name": "2.1", "digest": DIGEST1}],
            "next": "https://example.org/next_page",
        }
        response2 = Mock()
        response2.json.return_value = {"results": [{"name": "2.2", "digest": DIGEST2}]}
    ...
    def test_invalid_new_tag(self, mock_get: Mock):
        ...
        self.create_mock_response(mock_get, {"results": [{"name": "invalid", "digest": DIGEST}]})
    ...
    def test_prerelease(self, mock_get: Mock):
        ...
        self.create_mock_response(mock_get, {"results": [{"name": "1.4a1", "digest": DIGEST}]})
    ...
    def test_different_suffix(self, mock_get: Mock):
        ...
        self.create_mock_response(mock_get, {"results": [{"name": "1.4-windows", "digest": DIGEST}]})
    ...
    def test_within_cooldown(self, mock_get: Mock):
        ...
        self.create_mock_response(mock_get, {"results": [{"name": "1.4", "digest": DIGEST, "tag_last_pushed": recent}]})
    ...
    def test_outside_cooldown(self, mock_get: Mock):
        ...
        self.create_mock_response(mock_get, {"results": [{"name": "1.4", "digest": DIGEST, "tag_last_pushed": old}]})
