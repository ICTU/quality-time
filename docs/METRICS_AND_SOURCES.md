...
| Source version | The version number of the source. | ≧ 1.0  | version_number | ci | [Cobertura](#source-version-from-cobertura), [OWASP Dependency Check](#source-version-from-owasp-dependency-check), [OWASP ZAP](#source-version-from-owasp-zap), [Robot Framework](#source-version-from-robot-framework), [cloc](#source-version-from-cloc) |
