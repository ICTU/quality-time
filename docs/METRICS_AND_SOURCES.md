...
| TEST2 Accessibility violations | The number of accessibility violations in the web user interface of the software. | ≦ 0 violations | count | accessibility | [Axe CSV](#test2-accessibility-violations-from-axe-csv), [Axe-core](#test2-accessibility-violations-from-axe-core) |
...
| [Axe CSV](https://github.com/ICTU/axe-reports) | An Axe accessibility report in CSV format. | [TEST2 Accessibility violations](#test2-accessibility-violations-from-axe-csv) |
| [Axe-core](https://github.com/dequelabs/axe-core) | Axe is an accessibility testing engine for websites and other HTML-based user interfaces. | [TEST2 Accessibility violations](#test2-accessibility-violations-from-axe-core), [Source up-to-dateness](#source-up-to-dateness-from-axe-core), [Source version](#source-version-from-axe-core) |
...
### TEST2 Accessibility violations from Axe CSV
...
### TEST2 Accessibility violations from Axe-core
