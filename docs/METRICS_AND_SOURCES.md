...
| [JSON file with security warnings](https://github.com/ICTU/quality-time/blob/master/docs/GENERIC_REPORTS.MD) | A generic vulnerability report with security warnings in JSON format | [Security warnings](#security-warnings-from-json-file-with-security-warnings) |
