...
| [Anchore Jenkins plugin](https://plugins.jenkins.io/anchore-container-scanner/) | A Jenkins job with an Anchore report produced by the Anchore Jenkins plugin. | [Security warnings](#security-warnings-from-anchore-jenkins-plugin) |
