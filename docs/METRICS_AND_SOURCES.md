...
| Source version | The version number of the source. | ≧ 1.0  | version_number | ci | [Cobertura](#source-version-from-cobertura), [OWASP Dependency Check](#source-version-from-owasp-dependency-check), [cloc](#source-version-from-cloc) |
