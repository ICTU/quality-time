...
- Keep track of changes made by users in a change log per report. The change log can be viewed my expanding the report title. Closes [#285](https://github.com/ICTU/quality-time/issues/285).
