...
- When measuring violations with SonarQube as source, include the creation date and last update date of violations in the metric details. Closes [#1564](https://github.com/ICTU/quality-time/issues/1564).
