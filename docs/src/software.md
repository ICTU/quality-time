...
| `LDAP_LOOKUP_USER_PASSWORD_FILE` | None                                      | Filename of file with the LDAP lookup user password.                                                                                                                                                                                                                        |
| `LDAP_LOOKUP_USER_PASSWORD`      | `admin`                                   | LDAP lookup user password. This value is only used when `LDAP_LOOKUP_USER_PASSWORD_FILE` is not provided.                                                                                                                                                                   |
