...
- Add support for Gatling as source for the 'slow transactions', 'tests', and 'performancetest duration' metrics. Closes [#3085](https://github.com/ICTU/quality-time/issues/3085), [#3086](https://github.com/ICTU/quality-time/issues/3086), and [#3087](https://github.com/ICTU/quality-time/issues/3087).
