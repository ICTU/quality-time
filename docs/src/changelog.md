...
- In the UI, show a spinner while a metric is being measured because the source parameters were recently changed. Closes [#3134](https://github.com/ICTU/quality-time/issues/3134).
