...
- Add support for Gatling JSON (stats.json) reports as source for the 'slow transactions' metric. Closes [#3085](https://github.com/ICTU/quality-time/issues/3085).
