...
- Use the 'number of dates' menu in the hamburger menu to switch between what used to called 'trend' view (multiple dates) and 'details' view (one date). Closes [#3206](https://github.com/ICTU/quality-time/issues/3206).
