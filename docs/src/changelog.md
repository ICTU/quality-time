...
- Add support for Gatling JSON (stats.json) reports as source for the 'slow transactions' and 'tests' metrics. Closes [#3085](https://github.com/ICTU/quality-time/issues/3085) and [#3086](https://github.com/ICTU/quality-time/issues/3086).
- Add support for Gatling logs (simulation.log) as source for the 'performancetest duration' metric. Closes [#3087](https://github.com/ICTU/quality-time/issues/3087).
