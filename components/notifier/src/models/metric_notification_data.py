...
class MetricNotificationData:
    ...
    def __init__(
        ...
        self.metric_unit_plural = metric.get("unit_plural") or metric_type.unit_plural.value
        self.metric_unit_singular = metric.get("unit_singular") or metric_type.unit_singular.value
