...
const dataModel = {
    metrics: {
        violations: { direction: "<", unit_plural: "violations", unit_singular: "violation" },
        duration: { direction: "<", unit_plural: "minutes", unit_singular: "minute" },
    },
}
...
it("used the singular unit if the technical debt popup", async () => {
    const { container } = renderMeasurementTarget({
        type: "violations",
        debt_target: "1",
        target: "100",
