...
export function Feed(props) {
    return <SemanticUIFeed {...props} />
}

function FeedDate(props) {
    return <SemanticUIFeed.Date {...addInvertedClassNameWhenInDarkMode(props, useContext(DarkMode))} />
}

function Summary(props) {
    return <SemanticUIFeed.Summary {...addInvertedClassNameWhenInDarkMode(props, useContext(DarkMode))} />
}
