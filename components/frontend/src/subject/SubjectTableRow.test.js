...
it('shows the delta column', () => {
    ...
    expect(screen.getAllByLabelText("The measurement value worsened by +2").length).toBe(1);
    expect(screen.getAllByText("-4").length).toBe(1);
    expect(screen.getAllByLabelText("The measurement value improved by -4").length).toBe(1);
})
...
it('takes the metric direction into account', () => {
    ...
    expect(screen.getAllByText("+2").length).toBe(1);
    expect(screen.getAllByLabelText("The measurement value improved by +2").length).toBe(1);
    expect(screen.getAllByText("-4").length).toBe(1);
    expect(screen.getAllByLabelText("The measurement value worsened by -4").length).toBe(1);
})
...
it('works for informative metrics', () => {
    ...
    expect(screen.getAllByText("+2").length).toBe(1);
    expect(screen.getAllByLabelText("The measurement value changed by +2").length).toBe(1);
    expect(screen.getAllByText("-4").length).toBe(1);
    expect(screen.getAllByLabelText("The measurement value changed by -4").length).toBe(1);
})
