...
const measurementHelp = (
    <>
        ...
        <p>
            ...
            <Typography display="inline" bgcolor="error.main">
                red background
            </Typography>
...
const targetHelp = (
    <>
        ...
        <p>
            ...
            <Typography display="inline" bgcolor="grey">
                grey background
            </Typography>{" "}
...
function InlineChip({ color, label }) {
    return (
        <Paper elevation={0} sx={{ display: "inline-flex" }}>
            <Chip color={color} label={label} size="small" sx={{ borderRadius: 1 }} variant="outlined" />
        </Paper>
    )
}
