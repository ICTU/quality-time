...
Given(/^a metric whose measurement value is (.+) as the target value$/, (startValue) => {
    cy.get("#root > div.ui.fluid.container > div:nth-child(3) > table > tbody > tr:nth-child(3)")
        .as('testLineCoverage');
    ...
    cy.get("#root > div.ui.fluid.container > div:nth-child(3) > table > tbody > tr:nth-child(4)")
        .as('metricScreen');
