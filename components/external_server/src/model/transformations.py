...
def hide_credentials(data_model, *reports: Report) -> None:
...
def encrypt_credentials(data_model, public_key: str, *reports: Report):
...
def encrypt_source_credentials(data_model, public_key: str, *reports: Report):
...
def encrypt_issue_tracker_credentials(public_key: str, *reports: Report):
...
def decrypt_credentials(data_model, private_key: str, *reports: Report):
...
def decrypt_source_credentials(data_model, private_key: str, *reports: Report):
...
def decrypt_issue_tracker_credentials(private_key: str, *reports: Report):
...
def replace_report_uuids(*reports: Report) -> None:
