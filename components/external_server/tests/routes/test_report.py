...
class ReportTest(ReportTestCase):
    ...
    def test_get_pdf_report(self, requests_get):
        ...
        requests_get.assert_called_once_with(f"http://renderer:9000/api/render?path={REPORT_ID}", timeout=120)
    ...
    def test_get_pdf_tag_report(self, requests_get):
        ...
        requests_get.assert_called_once_with("http://renderer:9000/api/render?path=tag-security", timeout=120)
...
"""
        ...
        self.expected_password_length = 2  # the password is a tuple of encrypted Fernet key and encrypted password
    ...
    def test_get_json_report(self):
        ...
        self.assertTrue(len(exported_password) == self.expected_password_length)
