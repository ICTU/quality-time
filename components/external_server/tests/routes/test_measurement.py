...
from routes.measurement import get_metric_measurements, get_measurements, set_entity_attribute, stream_nr_measurements
...
class GetMetricMeasurementsTest(DatabaseTestCase):
    ...
    def test_get_old_but_not_new_measurements(self, request):
        ...
        def find_one_side_effect(query, projection, sort=None) -> list[dict[str, str]]:
