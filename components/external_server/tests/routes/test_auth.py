...
from routes.auth import login, logout, get_public_key
...
class AuthTestCase(DatabaseTestCase):
    ...
    def test_get_public_key(self, *mocks: Mock):  # noqa: ARG002
...
@patch.object(ldap3.Connection, "__exit__", lambda *args: None)  # noqa: ARG005
