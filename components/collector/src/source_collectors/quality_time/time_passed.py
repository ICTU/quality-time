"""Quality-time time passed collector."""
...
class QualityTimeTimePassed(QualityTimeCollector, TimePassedCollector):
    """Collector to get the time passed since the latest measurement from Quality-time."""
