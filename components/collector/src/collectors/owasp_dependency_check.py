...
from ..type import Namespaces, Entity, Entities, Parameter, Value
...
class OWASPDependencyCheckSecurityWarnings(Collector):
    ...
    def vulnerable_dependencies(
            self, tree: Element, namespaces: Namespaces, **parameters: Parameter) -> List[Tuple[int, Element]]:
    ...
    @staticmethod
    def vulnerabilities(element: Element, namespaces: Namespaces, **parameters: Parameter) -> List[Element]:
