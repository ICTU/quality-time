...
from ..type import Entity, Entities, URL, Parameter, Value
...
class TrelloBase(Collector):
    ...
    def board_id(self, **parameters: Parameter) -> str:
    ...
    def url_with_auth(self, api_part: str, **parameters: Parameter) -> str:
...
class TrelloIssues(TrelloBase):
    ...
    @staticmethod
    def ignore_card(card, lists, **parameters: Parameter) -> bool:
