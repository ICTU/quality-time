...
class JiraBase(Collector):
    ...
    def fields(self, **parameters: Parameter) -> str:  # pylint: disable=unused-argument,no-self-use
...
class JiraReadyUserStoryPoints(JiraBase):
    ...
    def fields(self, **parameters: Parameter) -> str:
        return super().fields(**parameters) + "," + cast(str, parameters["story_points_field"])
