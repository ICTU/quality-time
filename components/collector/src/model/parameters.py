...
class SourceParameters:
    ...
    def get(self, parameter_key: str, quote: bool = False) -> str | list[str]:
        ...
        value = self.__parameters.get(parameter_key) or parameter_info.default_value
        if parameter_info.type in ("multiple_choice_with_defaults", "multiple_choice_without_defaults"):
