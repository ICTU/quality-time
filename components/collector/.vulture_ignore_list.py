...
buildable  # unused variable (src/source_collectors/jenkins/base.py:27)
...
JenkinsPipelineDuration  # unused class (src/source_collectors/jenkins/pipeline_duration.py:12)
