...
BitbucketMergeRequests  # unused class (src/source_collectors/bitbucket/merge_requests.py:12)
...
GitLabPipelineDuration  # unused class (src/source_collectors/gitlab/pipeline_duration.py:12)
