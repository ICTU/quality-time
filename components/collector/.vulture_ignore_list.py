...
GitLabSourceUpToDateness  # unused class (src/source_collectors/gitlab/source_up_to_dateness.py:96)
__new__  # unused function (src/source_collectors/gitlab/source_up_to_dateness.py:99)
