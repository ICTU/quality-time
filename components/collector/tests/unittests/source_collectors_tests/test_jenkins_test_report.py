...
class JenkinsTestReportTest(SourceCollectorTestCase):
    ...
    def collect(self, metric, get_json=None):
        ...
        jenkins_response.json.return_value = get_json
    ...
    def test_nr_of_tests(self):
        ...
        response = self.collect(metric, dict(passCount=4, failCount=2))
    ...
    def test_nr_of_failed_tests(self):
        ...
        response = self.collect(metric, jenkins_json)
    ...
    def test_source_up_to_dateness(self):
        ...
        response = self.collect(metric, dict(suites=[dict(timestamp="2019-04-02T08:52:50")]))
