...
class DaysAgoTest(unittest.TestCase):
    ...
    def test_last_week(self):
        ...
        self.assertEqual(7, days_ago(now() - timedelta(days=7)))
...
class DaysToGoTest(unittest.TestCase):
    ...
    def test_next_week(self):
        ...
        self.assertEqual(7, days_to_go(now() + timedelta(days=7)))
...
class DateTimeFromPartsTest(unittest.TestCase):
    ...
    def test_datetime_with_time(self):
        """Test thst the time can be passed."""
    ...
    def test_datetime_without_time(self):
        """Test thst the time can be left out."""
...
class DateTimeFromTimestampTest(unittest.TestCase):
    ...
    def test_timezone(self):
        """Test thst the datetime has the local timezone."""
        self.assertEqual(datetime(1970, 1, 12, 14, 46, 40, tzinfo=tzlocal()), datetime_fromtimestamp(1000000))
