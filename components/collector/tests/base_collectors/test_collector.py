...
class CollectorTest(unittest.IsolatedAsyncioTestCase):
    ...
    def expected_measurement(
        self,
        *,
        source_parameter_hash: str = "f130a309914c463c7e076af8cdbe379e",
    ...
    async def test_fetch_successful_with_landing_url(self):
        ...
        post.assert_called_once_with(
            ...
            self.expected_measurement(
                source_parameter_hash="24bbb315d201d8c7a7f931aa2383e105",
    ...
    async def test_prioritize_edited_metrics(self):
        ...
        expected_call2 = call(
            self.database,
            self.expected_measurement(
                source_parameter_hash="5cb8bbb036faf4851f394057ce3ad354",
    ...
    async def test_missing_mandatory_parameter_with_default_value(self):
        ...
        post.assert_called_once_with(
            self.database,
            self.expected_measurement(
                source_parameter_hash="a21cafb4c405e6997671a02e578b9b1e",
                value="0",
                total="100",
                entities=[],
                api_url="",
