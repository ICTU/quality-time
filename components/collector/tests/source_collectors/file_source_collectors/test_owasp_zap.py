    ...
    async def test_warnings(self):
        ...
        expected_entities = [
            dict(
                ...
                old_key=md5_hash(f"10021:16:15:3:GET:{url1}"), name=self.warning_name,
            ...
            dict(
                ...
                old_key=md5_hash(f"10021:16:15:3:GET:{url2}"), name=self.warning_name,
    ...
    async def test_variable_url_regexp(self):
        ...
        expected_entities = [
            dict(
                ...
                old_key=md5_hash(f"10021:16:15:3:GET:{stable_url}"), name=self.warning_name, uri=stable_url,
