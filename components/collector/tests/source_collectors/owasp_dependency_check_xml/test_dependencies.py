"""Unit tests for the OWASP Dependency-Check XML dependencies collector."""
...
class OWASPDependencyCheckXMLDependenciesTest(OWASPDependencyCheckXMLTestCase):
    """Unit tests for the OWASP Dependency-Check XML collectors."""
