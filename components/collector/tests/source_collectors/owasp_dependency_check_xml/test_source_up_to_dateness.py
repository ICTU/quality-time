"""Unit tests for the OWASP Dependency-Check XML source up-to-dateness collector."""
...
class OWASPDependencyCheckXMLSourceUpToDatenessTest(OWASPDependencyCheckXMLTestCase):
    """Unit tests for the OWASP Dependency-Check XML source up-to-dateness collector."""
