...
class JiraVelocityTest(JiraTestCase):
    ...
    def setUp(self):
        ...
        self.boards_json1 = {
            ...
            "startAt": 0,
            "isLast": False,
            "values": [{"id": 0, "name": "Board 0"}, {"id": 1, "name": "Board 1"}],
        }
        self.boards_json2 = {
            "maxResults": 2,
            "startAt": 2,
            "isLast": True,
            "values": [{"id": 2, "name": "Board 2"}, {"id": 3, "name": "Board 3"}],
        }
        self.velocity_json = {
            "sprints": [
                {"id": 4, "name": "Sprint 4", "goal": "Goal 4"},
                {"id": 3, "name": "Sprint 3", "goal": "Goal 3"},
                {"id": 2, "name": "Sprint 2", "goal": ""},
            ],
            "velocityStatEntries": {
                "2": {"estimated": {"value": 65, "text": "65.0"}, "completed": {"value": 30, "text": "30.0"}},
                "3": {"estimated": {"value": 62, "text": "62.0"}, "completed": {"value": 48, "text": "48.0"}},
                "4": {"estimated": {"value": 40, "text": "40.0"}, "completed": {"value": 42, "text": "42.0"}},
            },
        }

    def sprint_entity(self, key: str, points_completed: float, points_committed: float, goal: bool = True):
        """Create an entity."""
        parameters = cast(dict[str, str], self.sources["source_id"]["parameters"])
        velocity_type = parameters.get("velocity_type", "completed points")
