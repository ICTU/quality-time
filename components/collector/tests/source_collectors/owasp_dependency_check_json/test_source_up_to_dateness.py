"""Unit tests for the OWASP Dependency-Check JSON source up-to-dateness collector."""
...
class OWASPDependencyCheckJSONSourceUpToDatenessTest(OWASPDependencyCheckJSONTestCase):
    """Unit tests for the OWASP Dependency-Check JSON source up-to-dateness collector."""
