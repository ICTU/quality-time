...
class ClocVersionTest(SourceCollectorTestCase):
    ...
    async def test_version(self):
        ...
        measurement = await self.collect_measurement(get_request_json_return_value={"header": {"cloc_version": "1.86"}})
        self.assert_measurement(measurement, value="1.86")
    ...
    async def test_newer_version_available(self):
        ...
        self.assert_measurement(measurement, value="1.86", info_message="Latest available version is 1.87")
