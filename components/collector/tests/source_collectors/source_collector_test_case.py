...
from model import SourceMeasurement
...
class SourceCollectorTestCase(unittest.IsolatedAsyncioTestCase):
    ...
    def assert_measurement(self, measurement: SourceMeasurement, *, source_index: int = 0, **attributes: str) -> None:
    ...
    def __assert_measurement_source_attribute(
        self,
        attribute_key: str,
        expected_attribute_value: list[dict] | dict,
