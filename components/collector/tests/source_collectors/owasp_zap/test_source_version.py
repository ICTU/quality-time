...
class OWASPZAPSourceVersionTest(OWASPZAPTestCase):
    ...
    async def test_source_version(self):
        ...
        measurement = await self.collect_measurement(
            get_request_text=xml, get_request_json_return_value={"tag_name": "2.7.1"}
        )
        self.assert_measurement(measurement, value="2.7.0")
    ...
    async def test_newer_version(self):
        ...
        self.assert_measurement(measurement, value="2.7.0", info_message="Latest available version is 2.7.1")
    ...
    async def test_source_version_zap_weekly(self):
        ...
        self.assert_measurement(measurement, value="2022.1.1")
