...
class BanditSecurityWarningsTest(BanditTestCase):
    ...
    async def test_warnings(self):
        ...
        measurement = await self.collect_measurement(get_request_json_return_value=self.bandit_json)
        self.assert_measurement(measurement, value="1", entities=self.expected_entities)
