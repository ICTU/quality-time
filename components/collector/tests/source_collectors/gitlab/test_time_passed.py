"""Unit tests for the GitLab time passed collector."""
...
class GitlabTimePassedTest(GitLabTestCase):
    """Unit tests for the time passed metric."""
    ...
    async def test_time_passed_file(self):
    ...
    async def test_time_passed_folder(self):
