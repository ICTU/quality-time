...
<html>
    ...
    async def test_tests(self):
        ...
        self.assert_measurement(measurement, value="28", total="28")
    ...
    async def test_failed_tests(self):
        ...
        measurement = await self.collect_measurement(get_request_text=self.HTML)
        self.assert_measurement(measurement, value="8", total="28")
    ...
    async def test_succeeded_tests(self):
        ...
        measurement = await self.collect_measurement(get_request_text=self.HTML)
        self.assert_measurement(measurement, value="20", total="28")
    ...
    async def test_ignored_tests(self):
        ...
        measurement = await self.collect_measurement(get_request_text=self.HTML)
        self.assert_measurement(measurement, value="10", total="10")
    ...
    async def test_failed_and_ignored_tests(self):
        ...
        measurement = await self.collect_measurement(get_request_text=self.HTML)
        self.assert_measurement(measurement, value="3", total="10")
