...
run pip-audit --strict --progress-spinner=off -r requirements-base.txt -r requirements.txt -r requirements-dev.txt
run safety check --bare --ignore 41002 -r requirements-base.txt -r requirements.txt -r requirements-dev.txt  # See https://github.com/nedbat/coveragepy/issues/1200
