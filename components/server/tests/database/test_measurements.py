...
from database.measurements import Metric, calculate_measurement_value, determine_measurement_status
...
class DetermineMeasurementStatusTest(unittest.TestCase):
    ...
    def test_green(self):
        ...
        metric = Metric(
            self.data_model,
            dict(type="metric_type", target="20", near_target="15", debt_target=None, accept_debt=False),
        )
        self.assertEqual("target_met", determine_measurement_status(metric, "10"))

    def test_yellow(self):
        """Test a yellow measurement."""
        metric = Metric(
            self.data_model,
            dict(type="metric_type", target="20", near_target="25", debt_target=None, accept_debt=False),
        )
        self.assertEqual("near_target_met", determine_measurement_status(metric, "22"))
    ...
    def test_red(self):
        ...
        self.assertEqual("target_not_met", determine_measurement_status(metric, "30"))
    ...
    def test_debt_met(self):
        ...
        self.assertEqual("debt_target_met", determine_measurement_status(metric, "30"))
    ...
    def test_debt_not_met(self):
        ...
        self.assertEqual("target_not_met", determine_measurement_status(metric, "35"))
    ...
    def test_debt_past_end_date(self):
        ...
        self.assertEqual("target_not_met", determine_measurement_status(metric, "29"))
    ...
    def test_debt_end_date_removed(self):
        ...
        self.assertEqual("debt_target_met", determine_measurement_status(metric, "29"))
    ...
    def test_green_with_debt(self):
        ...
        self.assertEqual("target_met", determine_measurement_status(metric, "15"))
    ...
    def test_near_target_worse_than_target(self):
        ...
        self.assertEqual("target_met", determine_measurement_status(metric, "17"))
