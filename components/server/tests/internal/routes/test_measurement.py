...
@patch("internal.model.measurement.iso_timestamp", new=Mock(return_value="2019-01-01"))
@patch("internal.model.source.iso_timestamp", new=Mock(return_value="2020-01-01"))
...
class PostMeasurementTests(unittest.TestCase):
    ...
    @patch("internal.server_utilities.functions.datetime", new=Mock(now=Mock(return_value=datetime(2021, 1, 1))))
