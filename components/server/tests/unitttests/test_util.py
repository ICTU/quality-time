...
from server.util import iso_timestamp, report_date_time, uuid
...
class UtilTests(unittest.TestCase):
    ...
    def test_iso_timestamp(self):
        ...
        with patch("server.util.datetime") as date_time:
    ...
    def test_report_date_time(self):
        ...
        with patch("server.util.bottle.request") as request:
