...
@bottle.post("/api/v3/metric/new/<subject_uuid>", permissions_required=["edit_report"])
...
@bottle.post("/api/v3/metric/<metric_uuid>/copy/<subject_uuid>", permissions_required=["edit_report"])
...
@bottle.post("/api/v3/metric/<metric_uuid>/move/<target_subject_uuid>", permissions_required=["edit_report"])
...
@bottle.delete("/api/v3/metric/<metric_uuid>", permissions_required=["edit_report"])
...
@bottle.post("/api/v3/metric/<metric_uuid>/attribute/<metric_attribute>", permissions_required=["edit_report"])
