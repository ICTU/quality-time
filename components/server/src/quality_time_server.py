...
def serve(reloader: bool = True) -> None:  # pragma: no cover-behave
    ...
    bottle.run(server="gevent", host="0.0.0.0", port=server_port, reloader=reloader, log=logging.getLogger())  # nosec
