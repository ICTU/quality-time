...
from github import get_latest_release_json, github_to_raw
...
def get_changes(package: str, version: str) -> str:
    ...
    for url_key, url in urls.items():
        if url_key.lower() in REPOSITORY_URL_KEYS and url.startswith("https://github.com"):
            organization, repository = url.split("/")[3:5]
